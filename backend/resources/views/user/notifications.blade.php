	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url({{asset('img/notify.jpg')}});">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
	...
	<style>
        ...
        .wrapper .promo-container #table td, #table th {
          padding: 10px;
        }

        .wrapper .promo-container #table tr:nth-child(even){
          background-color: #f2f2f2;
        }
        .wrapper .promo-container #table tr:nth-child(odd){
          background-color: #cdcfd0;
        }

        .wrapper .promo-container #table tr:hover {
          background-color: #ddd;
        }

        .wrapper .promo-container #table th {
          padding-top: 12px;
          padding-bottom: 12px;
          text-align: center; 
        ...
        .wrapper .promo-container #table tr td a{
        color: #34495e;
        cursor: pointer;
        transition: 0.3s;
        ...
        .wrapper .promo-container #table tr td a:hover{
        color: red;
        }
