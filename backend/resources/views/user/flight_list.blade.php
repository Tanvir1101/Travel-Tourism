	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			...
			<table class="table-fill">
				...
				@foreach ($ADFlightList as $flight)
					...
					<tr>
						...
						<td> {{$flight->type}} </td>
						<td> {{$flight->fare}} </td>
						<td> <img src="{{asset('upload')}}/{{$flight->image}}"  height="150" width="200"> </td>
						<td><a href="{{route('userConFlight.flightBook', [$flight->id])}}"><i class="fa fa-plus-circle" aria-hidden="true"></i></a></td>
					</tr>
