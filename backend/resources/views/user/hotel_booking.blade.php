	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url({{asset('img/hotel.jpg')}});">
			...
			<table class="table-fill">
				...
				<tbody class="table-hover">
					...
					@foreach ($HotelBookingsList as $hotelbooking)

					<tr>
						<td> {{$hotelbooking->id}} </td>
						<td>
						 	 User ID: {{session('id')}} <br>
							 Room ID: {{$hotelbooking->room_id}} <br>
							 Check In Date: {{$hotelbooking->fromdate}} <br>
							 Check Out Date : {{$hotelbooking->todate}} <br>
						</td>
					</tr>
