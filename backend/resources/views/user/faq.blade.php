	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url({{asset('img/faq.jpg')}});">
			...
			<main class="faq">
			 <div class="faq__holder">
			  ...
			  @foreach ($showFAQ as $faq)
			 
			  <details class="faq__detail">
			      <summary  class="faq__summary"><span class="faq__question"> {{$faq->que}}</span></summary>
			      <p class="faq__text"> {{$faq->ans}}</p>
			  </details>
