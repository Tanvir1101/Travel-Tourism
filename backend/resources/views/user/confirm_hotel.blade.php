					...
					<div class="col-md-3">
						<div class="sidebar-wrap">
							<div class="side search-wrap animate-box">
								<h3 class="sidebar-heading">Book your Hotel</h3>
								...
								<div class="col-md-12">
				                  <div class="form-group">
				                    <label for="date">Room ID:</label>
				                    <div class="form-field">
				                      <input type="text" id="room_id" name="room_id"class="form-control" value="{{old('id', $hotelroom->id)}}">
				                    </div>
				                  </div>
				                </div>
