	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url({{asset('img/cover-img-4.jpg')}});">
							...
							<div class="col-md-12">
								<div class="wrap-division">
									<div class="col-md-12 col-md-offset-0 heading2 animate-box">
										<h2>Royal Tulip Sea Pearl Beach Resort & Spa</h2>
									</div>
									<div class="row">
									...
									<div class="col-md-6 col-sm-6">
										<div class="desc">
											...
											<p><a href="{{route('userHotelRoom.facility')}}" class="btn btn-primary">Check Facility</a></p>
										</div>
									</div>

									@foreach ($showHotelRoom as $hotelroom)

										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url({{asset('upload')}}/{{$hotelroom->image}});"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2>Room ID: {{$hotelroom->id}}</h2>
															<h2>Hotel ID: {{$hotelroom->hotel_id}}</h2>
															<h2>{{$hotelroom->name}}</h2>
															<p class="price"><span>Price: {{$hotelroom->price}}</span></p>
															<p>{{$hotelroom->description}}</p>
															<p><a href="{{route('userConHotel.addHotelRoom', [$hotelroom->id])}}" class="btn btn-primary">Book Now!</a></p>
														</div>
													</div>
												</div>
											</div>
