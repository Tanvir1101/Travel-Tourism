	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="{{route('user.home')}}">home</a></div>
						</div>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url({{asset('img/bus.jpg')}});">
			...
			<table class="table-fill">
				...
				<tbody class="table-hover">
								...
								@foreach ($CarBookingsList as $Carbooking)

								<tr>
									<td>{{$Carbooking->id}}</td>
									<td>User ID: {{session('id')}} <br>
		 								Car ID: {{$Carbooking->car_id}} <br>
		 							 	From: {{$Carbooking->fromloc}} <br>
		                                To : {{$Carbooking->toloc}} <br>
		                                Check In Date: {{$Carbooking->fromdate}} <br>
		                                Check In Date : {{$Carbooking->todate}} <br>
	                                </td>
                                </tr>
