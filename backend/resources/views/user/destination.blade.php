				...
				<div class="row">
					<div class="col-md-9">
						<div class="row">
							...
							@foreach ($showDestinationList as $destination)

								<div class="col-md-6 col-sm-6 animate-box">   
									<div class="tour">
										<a href="{{route('userDestination.details', [$destination->id])}}" class="tour-img" style="background-image: url({{asset('upload')}}/{{$destination->image}});"></a>
										<span class="desc">
										<p><span>{{$destination->id}}</span></p>
											<h2><a href="{{route('userDestination.details', [$destination->id])}}">{{$destination->district}}</a></h2>
											<span class="city">{{$destination->place}}</span>
										</span>
									</div>
								</div>
