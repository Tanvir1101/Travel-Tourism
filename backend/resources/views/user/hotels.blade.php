				...
				<div class="row">
					<div class="col-md-9">
						<div class="row">
							...
							@foreach ($showHotelList as $hotel)

								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="{{route('userHotelRoom.showHotelRoom', [$hotel->id])}}" class="hotel-img" style="background-image:url({{asset('upload')}}/{{$hotel->image}});">
											<p><span>{{$hotel->id}}</span></p>
										</a>
										<div class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
											<h3><a href="{{route('userHotelRoom.showHotelRoom', [$hotel->id])}}">{{$hotel->name}}</a></h3>
											<span class="place">{{$hotel->location}}</span><br>
											{{$hotel->address}}<br>
