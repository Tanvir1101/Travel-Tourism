...
<html>
	...
	<title>Detsination Details</title>
	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url({{asset('img/sundarban2.jpg')}});">
			...
			<table class="table-fill">
				...
				<tbody class="table-hover">
					<tr>
						...
						<td><img src="{{asset('upload')}}/{{$destination->image}}"  height="150" width="200"> </td>
						<td><a href="{{route('userHotels.searchHotel', [$destination->district])}}" class="btn btn-primary">Search</a></td>
					</tr>
				</tbody>
			</table>
			</div>
