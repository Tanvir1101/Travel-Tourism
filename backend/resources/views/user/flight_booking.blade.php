	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			...
			<table class="table-fill">
				...
				@foreach ($FlightBookingsList as $flightbooking)

					<tr>
						<td> {{$flightbooking->id}} </td>
						<td> User ID: {{session('id')}} <br>
							 Air ID: {{$flightbooking->air_id}} <br>
							 From: {{$flightbooking->fromloc}} <br>
							 To : {{$flightbooking->toloc}} <br>
							 Check In Date: {{$flightbooking->fromdate}} <br>
							 Check In Date : {{$flightbooking->todate}} <br>
						</td>
					</tr>
