		...
		@include ('admin.sidebar')
			...
			<div class="main-container">
				...
				<table id = "table">
					...
					@foreach ($allEmployeeList as $emp)
						<tr>
							<td>{{$emp->id}}</td>
							<td>{{$emp->username}}</td>
							<td>{{$emp->firstname}}</td>
							...
							<td>{{$emp->email}}</td>
							<td>{{$emp->status}}</td>
							<td><a href="{{route('adminEmployee.employeeDetails', [$emp->id])}}"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a>
							<a href="{{route('adminEmployee.employeeDelete', [$emp->id])}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
						</tr>
					@endforeach
