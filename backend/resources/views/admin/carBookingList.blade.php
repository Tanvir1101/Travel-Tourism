	...
	<body>
		...
		@include ('admin.sidebar')
			...
			<div class="main-container">
				...
				<h1> <center> <b> Car Booking List </b> </center> </h1>
				<br>
                ...
                @foreach($carbooks as $carbook)
                    <tr>
                        ...
                        <td>{{$carbook->req}}</td>
						<td><a href="{{route('adminTransport.carBookingDetail', [$carbook->id])}}"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></td>
                    </tr>
                @endforeach
                </table>
