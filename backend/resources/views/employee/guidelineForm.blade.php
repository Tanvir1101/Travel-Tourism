...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Edit Travel Guidelines</title>
			    ...
			    <div class="form">
					...
					<form name="jsForm" method="POST">
						<fieldset>
							...
							<label for="guidelineForm">Write Travel Guidelines here:</label>
							<textarea name="guidelineForm" id="guidelineForm"  rows="30" cols="40">
								{{$guideline->guideline}}
							</textarea>
							<br>
