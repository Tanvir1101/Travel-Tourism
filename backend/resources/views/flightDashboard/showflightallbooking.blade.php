	...
	<body>
		...
		<div class="wrapper">
			...
			<div class="main-container">
				...
				<h1 style="color: #2e4154;"> <center> <b> Booking List </b> </center> </h1>
				<br>
				...
				@foreach($showflightallbooking as $flightbook)
					<tr>
					    <td> {{$flightbook->id}}  </td>
						...
						<td> <a href="{{route('flight.showuserflightinfo', [$flightbook->id])}}"><i class="fa fa-info-circle" aria-hidden="true"></i></a>            
						<a href="{{route('flight.bookingdelete', [$flightbook->id])}}"><i class="fa fa-trash" aria-hidden="true"></i></a> </td>
					</tr>
				@endforeach
				</table>	
