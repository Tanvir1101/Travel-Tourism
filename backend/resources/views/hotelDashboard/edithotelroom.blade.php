			...
			<div class="main-container">
				...
				<legend>Edit Room</legend>
					...
					@csrf
					 ...
					 <input type="text" id="price" name="price" value="{{$room->price}}" ><br><br>


					 <label for="description">Room Description</label>
				   <textarea name="description" id="description"  rows="7" cols="15" > {{$room->description}}</textarea>

				   <label for="availability">Room Availability:</label> <br> 
